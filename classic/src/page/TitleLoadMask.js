 ...
 *     myMask.show();
 */
Ext.define('Player.page.TitleLoadMask', {
    ...
    renderTpl: [
        ...
        '<div id="{id}-msgElTitle" data-ref="msgElTitle" class="ImageMouseover-init-title">{title}</div>',
        ...
        Ext.baseCSSPrefix, 'mask-msg-textlll',
        '{childElCls}">{msg}</div>',
        '</div>',
        '</div>'
    ],
    ...
    syncMaskState: function() {
        ...
        if (me.isVisible()) {
            ...
            me.msgElTitle.setHtml(me.title);
