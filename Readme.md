...
CoursePlayer is a cross platform, eLearning, course framework. CoursePlayer is designed to work on most Learning Management System (LMS), using SCORM 1.2, SCORM 2004, AICC, or TinCan. 

|           |                                                     |
|-----------|:---------------------------------------------------:|
| Author    |                     Jared Warren                    |
| Copyright | Copyright (c) 2015 Litmos Author (litmosauthor.com) |
| License   |                       GPL v3.0                      |



## Ext Js basic information
...
## Data Folder
All course data is stored in JSON format, within the data folder. 

    data/               # Contains all custom data for a course
        sco.json        # contains all basic page and quiz data
        settings.json   # contains setting information various features
        glossary.json   # contains all terms and definitions
...
This area is intended for overrides like these:
    ...
    Ext.define('Player.overrides.foo.Bar', {
